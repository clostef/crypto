        ...
        <div className="w-full max-w-[1400px] flex flex-col gap-10">
          ...
          >
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-3 rounded-lg text-red-500 hover:bg-gray-700 hover:text-white transform transition hover:scale-105"
            >
          ...
          <div className="hidden md:flex justify-between items-center">
            ...
            <div className="flex items-center gap-4">
              ...
              <button
                onClick={handleLogout}
                className="flex items-center gap-1 text-gray-300 transform transition hover:scale-105 hover:shadow-lg"
              >
          ...
          <div className="w-full bg-black border border-gray-700 rounded-xl p-6 shadow-2xl">
            ...
            <div className="flex flex-wrap justify-center items-center gap-5 mt-9 mb-8">
